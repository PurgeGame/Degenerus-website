...
import {
  ...
  buildDegeneretteRevealSequence,
  ...
  degeneretteLootboxEthFromLegs,
} from '../app/degenerette-replay.js';
// Preserve the panel's existing helper exports for integrations and tests.
export {
  dgnDecodePacked,
  mergeDegeneretteFeedItems,
  normalizeDegeneretteSpinResults,
